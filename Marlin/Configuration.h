...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 220
  ...
  #define DELTA_HEIGHT 290.00             // (mm) Get this value from G33 auto calibrate
...
#define STRING_CONFIG_H_AUTHOR "ku3mich@gmail.com" // Who made the changes.
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 6000, 6000, 6000, 18000 } // ...or, set your own edit limits
#endif
...
#define BLTOUCH_RESET_DELAY    450
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -52.4 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
// ku3mich negatives not accepted
...
#define Z_PROBE_OFFSET_RANGE_MIN -60
