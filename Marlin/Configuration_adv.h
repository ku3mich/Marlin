...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 50*60, 20*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
  #define FINE_MANUAL_MOVE 0.05    // (mm) Smallest manual move (< 0.1mm) applying to Z on most machines
  #if IS_ULTIPANEL
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define NEO2_USER_PRESET_BLUE         0  // User defined BLUE valueultralcd_impl_DOGM.h
...
#define LCD_SET_PROGRESS_MANUALLY
  ...
  #define SHOW_REMAINING_TIME       // Display estimated time to completion
    ...
    #define LCD_PROGRESS_BAR            // Show a progress bar on HD44780 LCDs for SD printing
      ...
      #define PROGRESS_MSG_EXPIRE   5000  // (ms) Amount of time to retain the status message (0=forever)
 ...
 */
  ...
  //#define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FS_PRIME_SPEED    (5*60)   // (mm/min) Extra priming feedrate
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_ACCEL      1500  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL   2500  // (mm/s^2) Lower acceleration may allow a faster feedrate.
